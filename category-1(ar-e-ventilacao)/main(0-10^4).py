...
output = []
total_company = 0
for price in range(0, 10000, 100):
    try:
        ...
        max_price = Send_Keys(max_price_input, f'{price + 100}')
        ...
        for category in categories:
            ...
            if category_names[0] == 'Vendido por':
                ...
                print(f'{price} ~ {price + 100} : company_number --> {len(company_names)}')
                ...
                break
        with open('output(0-10^4).json', 'w') as file:
