...
driver.get('https://www.magazineluiza.com.br/ar-e-ventilacao/l/ar/')

output = []
total_company = 0
for price in range(1000000, 4903673, 100000):
    try:
        ...
        max_price = Send_Keys(max_price_input, f'{price + 100000}')
        ...
        for category in categories:
            ...
            if category_names[0] == 'Vendido por':
                ...
                print(f'{price} ~ {price + 100000} : company_number --> {len(company_names)}')
                ...
                break
        with open('output(10^6-end).json', 'w') as file:
