...
output = []
total_company = 0
for price in range(100000, 1000000, 10000):
    try:
        ...
        max_price = Send_Keys(max_price_input, f'{price + 10000}')
        ...
        for category in categories:
            ...
            if category_names[0] == 'Vendido por':
                ...
                print(f'{price} ~ {price + 10000} : company_number --> {len(company_names)}')
                ...
                break
        with open('output(10^5-10^6).json', 'w') as file:
